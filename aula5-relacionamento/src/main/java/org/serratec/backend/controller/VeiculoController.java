...
import org.serratec.backend.exception.VeiculoException;
...
public class VeiculoController {
	...
	public Veiculo inserir(@Valid @RequestBody Veiculo veiculo) {
		...
		Veiculo veiculoProcurado = repository.findByPlaca(veiculo.getPlaca());
		if (veiculoProcurado != null) {
			throw new VeiculoException("Placa já existe no cadastro");
		}
